...
import { sendVerificationEmail, sendWelcomenEmail, sendPasswordResetEmail,sendResetSuccessEmail } from '../mailtrap/emails.js';
...
export const verifyEmail = async (req, res) => {
    ...
    try {
        ...
        await sendWelcomenEmail(user.email, user.name);
